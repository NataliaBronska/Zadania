...
class MildPizzaBuilder : public PizzaBuilder {
public:
	void buildDough() override
	{
...
int main()
{
	...
	MildPizzaBuilder mildBuilder;
	cook.makePizza(mildBuilder);
	Pizza mildPizza = mildBuilder.getPizza();
	mildPizza.displayPizza();
